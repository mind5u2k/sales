					...
					<div
						...
						<div role="content">
							<div class="widget-body fuelux">
								<sf:form action="${contextRoot}/cl/updateAssignedProducts"
									modelAttribute="assignedProduct" id="smart-form-register"
										...
										<fieldset>
											...
											<section>
												<label class="checkbox"> <sf:checkbox
														path="termsAndCondition" /> <i></i>I agree with the Terms
													and Conditions
												</label>
											</section>
										</fieldset>
