			...
			<div class="jarviswidget   jarviswidget-sortable" id="wid-id-1"
				...
				<header role="heading">
					...
					<button class="btn btn-primary" style="float: right;"
						onclick="addNewUserModel();">Assign Product</button>
				</header>
				<div role="content">
								...
								<thead>
									...
									<tr role="row">
										...
										<th data-hide="phone" class="sorting" tabindex="0"
											aria-controls="datatable_fixed_column" rowspan="1"
											colspan="1"
											aria-label="Age: activate to sort column ascending" style="">Product</th>
								...
								<tbody>
									<c:forEach items="${assignedProducts}" var="ap">
										...
										<tr role="row" class="odd">
											<td class="sorting_1">${ap.client.firstName}&nbsp;${ap.client.lastName}</td>
											<td>${ap.client.email}</td>
											<td>${ap.client.contactNumber}</td>
