			...
			<div class="jarviswidget   jarviswidget-sortable" id="wid-id-1"
				...
				<header role="heading">
					...
					<button class="btn btn-primary" style="float: right;"
						onclick="addNewUserModel();">Add Sales Organization</button>
				</header>
				<div role="content">
					<div class="widget-body no-padding">
						...
						<div id="datatable_fixed_column_wrapper"
							...
							<table id="datatable_fixed_column"
								...
								<thead>
									<tr role="row">
										<th class="hasinput" style="" rowspan="1" colspan="1"><input
											...
											placeholder="Filter Organization"></th>
										<th class="hasinput" style="" rowspan="1" colspan="1"><input
											type="text" class="form-control"
											placeholder="Filter Organizer"></th>
										<th class="hasinput" style="" rowspan="1" colspan="1"><input
									...
									<tr role="row">
										<th data-class="expand" class="sorting_asc" tabindex="0"
											...
											aria-label="Name: activate to sort column ascending" style="">Organization</th>
										<th data-class="expand" class="sorting_asc" tabindex="0"
											aria-controls="datatable_fixed_column" rowspan="1"
											colspan="1" aria-sort="ascending"
											aria-label="Name: activate to sort column ascending" style="">Organizer</th>
								...
								<tbody>
									<c:forEach items="${salesOrganizer}" var="salesOrganzr">
										<c:set var="i" value="${i+1}" scope="page" />
										<tr role="row" class="odd">
											<td class="sorting_1">${salesOrganzr.user.organizationName}
											</td>
											<td class="sorting_1">${salesOrganzr.user.firstName}&nbsp;${salesOrganzr.user.lastName}</td>
											<td>${salesOrganzr.user.email}</td>
											<td>${salesOrganzr.user.contactNumber}</td>
											<td>${salesOrganzr.user.role}</td>
											<td
												style="text-align: center; padding: 0; vertical-align: middle;"><c:if
													test="${salesOrganzr.user.enabled == true}">
												...
												</c:if> <c:if test="${salesOrganzr.user.enabled == false}">
													<span class="onoffswitch"> <input type="checkbox"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content" id="newUserBody">
			<sf:form action="${contextRoot}/ad/addSalesOrganizer"
				...
				<header> Organizer Details</header>
				<fieldset>
					<div class="row">
