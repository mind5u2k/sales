			...
			<div class="jarviswidget   jarviswidget-sortable" id="wid-id-1"
				...
				<header role="heading">
					...
					<button class="btn btn-primary" style="float: right;"
						onclick="addNewUserModel();">Add New User</button>
				</header>
				<div role="content">
								...
								<tbody>
									<c:forEach items="${users}" var="u">
										...
										<tr role="row" class="odd">
											<td class="sorting_1">${u.firstName}&nbsp;${u.lastName}</td>
											<td>${u.email}</td>
											...
											<td
												...
												</c:if> <c:if test="${u.enabled == false}">
													<span class="onoffswitch"> <input type="checkbox"
...
<div class="modal fade" id="newUserModel" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content" id="newUserBody">
			<sf:form action="${contextRoot}/su/addUser" modelAttribute="user"
				...
				<fieldset>
					...
					<div class="row">
						<section class="col col-6">
							<label class="input"> <i
								class="icon-prepend fa fa-envelope-o"></i> <sf:input type="text"
									path="email" placeholder="E-Mail" />
							</label>
						</section>
						<section class="col col-6">
							<label class="select"> <sf:select path="role">
									<option value="0" disabled="disabled" selected="selected">Role</option>
