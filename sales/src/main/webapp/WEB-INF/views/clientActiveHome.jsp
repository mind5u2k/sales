					...
					<div class="widget-body">
						<div class="row">
							...
							<div class="col-lg-4"
								...
								Status - <span class="text-success"><i
									class="fa fa-check-square-o"></i> Active</span>
							</div>
						</div>
						<div class="row" style="text-align: center;">
							...
							<div class="col-lg-6" style="padding: 6px; font-size: 16px;">
								!! Your Product is in <span class="text-success"><i
									class="fa fa-check-square-o"></i> Active</span> State !!<br>
							</div>
							<div class="col-lg-6" style="padding: 6px; font-size: 16px;">
