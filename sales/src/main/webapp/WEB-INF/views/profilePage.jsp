								...
								<sf:form action="${contextRoot}/cl/updateProfile"
									...
									<div class="step-content">
										...
										<fieldset>
											...
											<section>
												<label class="input"> <i
													class="icon-append fa fa-envelope-o"></i> <sf:input
														type="email" path="email" placeholder="Email address" />
											...
											<section>
												<label class="input"> <i
													class="icon-append fa fa-lock"></i> <sf:input
											...
											<!-- <section>
												<label class="input"> <i class="icon-append fa  "></i>
													...
													placeholder="Address Line 1" id="password"> <b
													class="tooltip tooltip-bottom-right">Don't forget your
														password</b>
												</label>
											</section>
											<section>
												<label class="input"> <i
													...
													name="passwordConfirm" placeholder="Address Line 2">
													<b class="tooltip tooltip-bottom-right">Don't forget
														your password</b>
												</label>
											</section>
											<div class="row">
												...
												<section class="col col-6">
													<label class="select"> <select name="gender">
															<option value="0" selected="" disabled="">Postal
																Code</option>
															<option value="1">Male</option>
															<option value="2">Female</option>
															<option value="3">Prefer not to answer</option>
											...
											<section>
												<label class="checkbox"> <input type="checkbox"
													name="terms" id="terms"> <i></i>I agree with the
